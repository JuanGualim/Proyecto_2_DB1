...
BEGIN
    ...
    START TRANSACTION;
        ...
        INSERT INTO venta (fecha, total, id_cliente, id_empleado) VALUES (NOW(), v_total, p_id_cliente, p_id_empleado);
        SET p_id_venta = LAST_INSERT_ID();
        INSERT INTO detalle_venta (id_venta, id_producto, cantidad, precio_unitario) VALUES (p_id_venta, p_id_producto, p_cantidad, p_precio);
...
BEGIN
    ...
    ELSE
        START TRANSACTION;
            INSERT INTO producto (nombre, precio, stock, id_categoria, id_proveedor) VALUES (p_nombre, p_precio, p_stock, p_id_categoria, p_id_proveedor);
...
BEGIN
    ...
    END;
    SELECT COUNT(*) INTO v_ventas FROM detalle_venta WHERE id_producto = p_id_producto;
    IF v_ventas > 0 THEN
...
BEGIN
    ...
    ELSE
        START TRANSACTION;
            INSERT INTO cliente (nombre, email, telefono) VALUES (p_nombre, p_email, p_telefono);
            SET p_id_nuevo = LAST_INSERT_ID();
        COMMIT;
        SET p_resultado = 'OK';
    END IF;
